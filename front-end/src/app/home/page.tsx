        ...
        <main>
            ...
            <div className="container mt-20">
                ...
                <div
                    ...
                    <div className="grid md:grid-cols-4 sm:grid-cols-2 lg:gap-7 gap-5  place-items-center max-w-7xl mx-auto">
                        <div className="grid place-items-center text-center group w-full">
                            <div
                                ...
                                <Image className="lg:w-[100px] w-[60px] lg:h-[100px] h-[60px]" src={PaperPlane} alt={"paper-plane"}/>
                            </div>
